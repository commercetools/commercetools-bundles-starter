...
- [AWS - S3 & CloudFront](https://appkit.commercetools.com/deployment/example-aws-s3-cloudfront)
 ...
 NOTE: Be sure to set the env vars in [custom-application-config.mjs](https://github.com/commercetools/commercetools-bundles-starter/tree/master/packages/bundles-static/custom-application-config.mjs) file. Update the value for your Merchant Center URL in that config: "mcURL":"..."
