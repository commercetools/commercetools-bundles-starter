...
---
NOTE: This package is based of the static bundles extension. This package serves as a starter for dynamic bundles to customize your cart flow solution.

# Platform Extension - Dynamic Bundles
{: .no_toc }
